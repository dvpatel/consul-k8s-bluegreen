...
func createRedirectTrafficConfig(svc *api.AgentServiceRegistration, checks map[string]*api.AgentCheck) (iptables.Config, error) {
	...
	//    consul.hashicorp.com/cni-proxy-config: '{"ConsulDNSIP":"","ProxyUserID":"frontend-64ffb57cb7-fxcvq-frontend-sidecar-proxy","ProxyInboundPort":20000,"ProxyOutboundPort":15001,"ExcludeInboundPorts":null,"ExcludeOutboundPorts":null,"ExcludeOutboundCIDRs":null,"ExcludeUIDs":null,"NetNS":"","IptablesProvider":null}'
	if svc.Proxy == nil {
